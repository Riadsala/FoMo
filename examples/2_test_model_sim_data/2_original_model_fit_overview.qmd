...
This seems to suggest that model 1.1 does a better job than model 1.0 (NOTE: there is a problem with high pareto K values, that needs further investigation - `moment_match = TRUE` is not currently working).
...
loo_1_1 <- m_simple_1_1$loo("W")
loo_1_0 <- m_simple_1_0$loo("W")
...
As above - problems with high pareto K values.
...
loo_1_1 <- m_ml_1_1$loo("W")
loo_1_0 <- m_ml_1_0$loo("W")
