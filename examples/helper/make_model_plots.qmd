...
- accuracy plots (including a plot that shows how accuracy changes across trials, and an average accuracy plot which will show the current model version alongside any other model versions you have calculated for easy comparison)
