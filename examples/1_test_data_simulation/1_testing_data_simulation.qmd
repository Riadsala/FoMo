...
We have some processing code `get_inter_targ_stats` which allows visualisation of target directions.. Going left is 180 degrees, down is -90 degrees, up is 90 degrees and going right is 0 degrees.
...
d_sacc %>% filter(person == 1, trial == 1, condition == "A") %>%
  ggplot(aes(x, y)) +
