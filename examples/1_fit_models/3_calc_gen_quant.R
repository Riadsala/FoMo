...
gen_quant("kristjansson2014plos", fomo_ver = "1.3", mode = "traintest", iter_genquant = iter, fif = TRUE)
...
gen_quant("clarke2022qjep", fomo_ver = "1.3", mode = "traintest", iter_genquant = iter, fif = TRUE)
...
gen_quant("tagu2022cog", fomo_ver = "1.3", mode = "traintest", iter_genquant = iter, fif = TRUE)
