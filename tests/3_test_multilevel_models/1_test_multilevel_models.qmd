...
m <- readRDS("scratch/2cond/sim_train_1_0.model")
d <- readRDS("scratch/2cond/d_1_0.rds")
...
rl10 <- read_csv("scratch/2cond/run_statistics_1_0.csv", 
                 show_col_types = FALSE) %>% mutate(model = "FoMo 1.0")
rl11 <- read_csv("scratch/2cond/run_statistics_1_1.csv", 
                 show_col_types = FALSE) %>% mutate(model = "FoMo 1.1")
rl12 <- read_csv("scratch/2cond/run_statistics_1_2.csv", 
                 show_col_types = FALSE) %>% mutate(model = "FoMo 1.2")
...
iisv <- bind_rows(
  read_csv("scratch/2cond/iisv_statistics_1_0.csv") %>% mutate(model = "1.0"),
  read_csv("scratch/2cond/iisv_statistics_1_1.csv") %>% mutate(model = "1.1"),
  read_csv("scratch/2cond/iisv_statistics_1_2.csv") %>% mutate(model = "1.2"))
