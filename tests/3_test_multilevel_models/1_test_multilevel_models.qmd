...
```{r}
plot_model_human_iisv_comparison(pred, d)
...
iisv_emp <- get_iisv_over_trials(d2$found) 
...
```{r}
plot_model_human_iisv_comparison(pred, d2)
...
```{r, fig.cap="fixed effects", warning = FALSE}
