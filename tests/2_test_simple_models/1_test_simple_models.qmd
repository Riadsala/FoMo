...
# extract post
post <- extract_post(m_simple_1_2, d1, multi_level = FALSE)
...
pred <- summarise_postpred(m_simple_1_2, d1, multi_level = FALSE, draw_sample_frac = 0.1)
...
train_test_simple_FoMo <- function(df_train, ds_train, df_test, ds_test, 
  ...
  mod <- cmdstan_model(paste0("../../models/simple/FoMo", str_replace(FoMo_ver, "\\.", "_" ), ".stan"))
